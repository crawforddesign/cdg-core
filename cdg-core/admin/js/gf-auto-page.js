...
(function ($) {
  ...
  function injectCheckbox(flyout) {
    ...
    field.innerHTML =
      ...
      "Creates a draft Divi page for this form automatically based on the layout in the Divi Theme Builder." +
      "</p>";

    bodyInner.appendChild(field);

    // Save checkbox state to sessionStorage when the create button is clicked.
    var createBtn = flyout.querySelector(
      ".gform-flyout__footer-primary-button"
    );
    if (createBtn) {
